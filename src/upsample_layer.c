...
void forward_upsample_layer(const layer l, network net)
{
    ...
    // }
    upsample_bilinear_cpu(net.input,l.w,l.h,l.c,l.batch,l.out_w,l.out_h,1,l.output);
}
...
void backward_upsample_layer(const layer l, network net)
{
    ...
    // }
    upsample_bilinear_cpu(l.delta,l.out_w,l.out_h,l.c,l.batch,l.w ,l.h, 0, net.delta);
}
